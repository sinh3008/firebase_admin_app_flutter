                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(telescope.brand.name, style: const TextStyle(fontSize: 16,),),
                            Text(telescope.model, style: const TextStyle(color: Colors.grey, overflow: TextOverflow.ellipsis),),
                          ],
                        ),
                      ),
                    ),
